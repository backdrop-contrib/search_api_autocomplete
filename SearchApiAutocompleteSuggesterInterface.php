...
interface SearchApiAutocompleteSuggesterInterface {
   ...
   *   following keys:
   *   - term: The keyword (or keywords) this suggestion will autocomplete to.
   ...
   *     behavior and thus makes "term" obsolete.
   ...
   *   "term", "url", "suggestion_prefix", "user_input" or "suggestion_suffix"
   *   has to be present.
   */
